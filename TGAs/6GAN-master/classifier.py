...
class IPv62Vec(object):
    ...
    def create_category(self):
        ...
        model = word2vec.Word2Vec(sentences, alpha=0.025, min_count=0, size=100, window=5,sg=0, hs=0, negative=5, ns_exponent=0.75, iter=5)
        
        #vocab = list(model.wv.vocab.keys())
        #vocab = list(model.wv.key_to_index.keys())
        vocab = list(model.wv.index2word)# gensim 3.7.1
        print(vocab)
